...
>
  ...
  <button
    ...
    className="absolute top-2 right-2 p-2 bg-green-700 hover:scale-125 ease-in-out text-white rounded-full hover:bg-green-600 transition-colors duration-800  z-10"
  >
  ...
  <div onClick={() => navigate(`/products/${products._id}`)} className="p-4">
    ...
    <div className="flex justify-between mt-4">
      <button
        ...
        className="bg-gradient-to-r from-cyan-700 to-cyan-950 text-white w-full hover:font-bold p-2 rounded-md hover:bg-red-600 transition-colors duration-200 ease-in-out"
      >
        Details
      </button>
    </div>
